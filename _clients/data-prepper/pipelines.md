...
from Amazon S3. This example uses Application Load Balancer logs. As the Application Load Balancer writes logs to S3, S3 creates notifications
in Amazon SQS. Data Prepper reads those notifications and reads the S3 objects to get the log data and process it.
