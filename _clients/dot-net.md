...
To get started with OpenSearch.Client, follow the [getting started guide]({{site.url}}{{site.baseurl}}/clients/OSC-dot-net#installing-opensearchclient) or a slightly [more advanced walkthrough]({{site.url}}{{site.baseurl}}/clients/osc-example).