...
This tutorial is mostly compatible with version 2.17 and later, except for the "[Using a template query and a search pipeline](#using-a-template-query-and-a-search-pipeline)" in "[Step 4: Search the index](#step-4-search-the-index)", which requires version 2.19 or later.
