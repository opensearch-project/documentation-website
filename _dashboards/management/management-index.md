...
- **[Saved objects]({{site.url}}{{site.baseurl}}/dashboards/management/saved-objects/)**: The **Saved Objects** tool helps you organize and manage your saved objects. Saved objects are files that store data, such as dashboards, visualizations, and maps, for later use. Use the tool to [export and import them]({{site.url}}{{site.baseurl}}/dashboards/management/saved-objects/), for example to copy a dashboard to another cluster, or to do the same programmatically with the [Saved Objects APIs]({{site.url}}{{site.baseurl}}/dashboards/management/saved-objects-api/).
...
- **[Resource access management]({{site.url}}{{site.baseurl}}/dashboards/management/resource-sharing/)** (if the experimental feature is enabled): The **Resource Access Management** tool provides fine-grained access control for plugin-defined resources such as machine learning (ML) model groups, anomaly detectors, and report definitions. You can share resources with specific users, roles, or backend roles and control their access levels.
