...
- **[Resource Access Management]({{site.url}}{{site.baseurl}}/dashboards/management/resource-sharing/)** (if resource sharing is enabled): The **Resource Access Management** tool provides fine-grained access control for plugin-defined resources such as machine learning (ML) model groups, anomaly detectors, and report definitions. You can share resources with specific users, roles, or backend roles and control their access levels.
