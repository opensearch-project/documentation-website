...
Area charts depict changes over time, and they are commonly used to show trends. Area charts more efficiently identify patterns in log data, such as sales data for a time range and trends over that time. See [Using area charts]({{site.url}}{{site.baseurl}}/dashboards/visualize/area/) to learn more about how to create and use them in Dashboards.
 ...
 ![Example area chart in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/dashboards/area-chart-1.png){: width="600" height="600" }
...
:-------------------------:|:-------------------------:
![Example vertical bar chart in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/dashboards/bar-chart-1.png){: width="300" height="300" }  |  ![Example horizontal bar chart in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/dashboards/bar-horizontal-1.png){: width="300" height="300" }
...
![Example visualization using controls to filter data in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/dashboards/controls-1.png){: width="600" height="600" }

### Data tables

Data tables, or tables, show your raw data in tabular form. 

![Example data table in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/data-table-1.png){: width="600" height="600" }
...
![Example gauge chart in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/dashboards/gauge-1.png){: width="400" height="400" }
...
![Example heat map in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/dashboards/heat-map-1.png){: width="600" height="600" }
...
![Example line graph in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/line-1.png){: width="600" height="600" }
...
![Example coordinate map in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/dashboards/coordinate-1.png){: width="600" height="600" }
...
![Example region map in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/map-1.png){: width="600" height="600" }
...
![Example coordinate map in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/dashboards/markdown.png){: width="600" height="600" }
...
![Example metric chart in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/dashboards/metric-chart-1.png){: width="400" height="400" }

### Pie charts

Pie charts compare values for items in a dimension, such as a percentage of a total amount. 

![Example pie chart in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/pie-1.png){: width="600" height="600" }
...
![Example TSVB in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/dashboards/TSVB-1.png){: width="600" height="600" }
...
![Example Tag cloud in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/word-cloud-1.png){: width="600" height="600" }
...
![Example Timeline in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/dashboards/timeline-1.png){: width="600" height="600" }
...
![Example VisBuilder in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/dashboards/vis-builder-2.png){: width="600" height="600" }
...
![Example Vega visualization with JSON specification in OpenSearch Dashboards]({{site.url}}{{site.baseurl}}/images/dashboards/vega-1.png){: width="600" height="600" }
