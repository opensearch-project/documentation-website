...
1. From the top menu, select **Visualize > Create visualization > VisBuilder**.
   ...
   ![Select the VisBuilder visualization type]({{site.url}}{{site.baseurl}}/images/dashboards/vis-builder-1.png){: width="550" }  
...
![Visualization generated using sample data]({{site.url}}{{site.baseurl}}/images/dashboards/drag-drop-generated-viz.png)
