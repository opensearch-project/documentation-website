...
_Visualize_ is the OpenSearch Dashboards application for creating visualizations. When displayed in bold, **Visualize** refers to the UI application, as displayed in [Navigating the Visualize UI]({{site.url}}{{site.baseurl}}/dashboards/visualize/viz-index/#navigating-the-visualize-ui).
