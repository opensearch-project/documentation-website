...
_{This is a template for writing a how-to or tutorial page for OpenSearch Dashboards. Introduce the topic here like this:}_
...
The following components comprise the **{APP}** UI.
...
- The _search bar_ (B) enables data selection using a query language search.
...
Before using the **{APP}** tool, you must complete the following prerequisites:
...
1. Select **{WHATEVER IT SAYS ON THE BUTTON TO COMPLETE THE TASK}**.
   ...
   ![Discover interface showing search of flight sample data for last 7 days]({{site.url}}{{site.baseurl}}/images/dashboards/define-search.png){: width="700" }
