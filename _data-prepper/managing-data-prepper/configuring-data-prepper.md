...
Use the following option to set how Peer Forwarder authenticates requests between peers.
...
The table below lists the available circuit breaker configuration blocks.
