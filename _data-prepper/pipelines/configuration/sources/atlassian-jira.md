...
| `authentication`  | Yes      | [authentication](#Authentication) | Configures authentication method to access `jira` source records from the specified host.                                                                                                                                         |
...
| Option   | Required | Type              | Description                                            |
|:---------|:---------|:------------------|:-------------------------------------------------------|
| `basic`  | Yes      | [basic](#basic-authentication)   | Basic Authentication credentials to access a Jira host.  |
| `oauth2` | Yes      | [oauth2](#oauth2-authentication)| OAuth2 Authentication credentials to access a Jira host. |

#### Basic authentication

Either basic or OAuth2 credentials are required to access the Jira site. If you use the `basic` authentication, the following fields are required.
...
| `status`     | No       | String | A list of list of status filters to include or exclude.     |
