...
acknowledgments | No | Boolean | If `true`, enables S3 sources to receive [end-to-end acknowledgments]({{site.url}}{{site.baseurl}}/data-prepper/pipelines/pipelines/#end-to-end-acknowledgements) when events are received by OpenSearch sinks.
