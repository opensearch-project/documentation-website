...
The `codec` determines how the `s3` source parses each S3 object. For increased and more efficient performance, you can use codecs in [combination]({{site.url}}{{site.baseurl}}/data-prepper/common-use-cases/codec-processor-combinations/) with certain processors.
