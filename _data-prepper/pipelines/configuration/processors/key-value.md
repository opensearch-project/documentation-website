...
destination | No | String | The key where the output is parsed source to. Outing the parsed source overwrites the value of the key if it already exists. Default value is `parsed_message`
