...
> Note - Starting in version 2.10.0, the `convert_entry_type` processor has been renamed to `convert_type`. The old name will emit a deprecation warning and should be updated to the new name.
