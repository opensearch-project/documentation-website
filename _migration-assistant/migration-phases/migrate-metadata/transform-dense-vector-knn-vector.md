...
Vector fields are not just a rename problem. The target mapping needs to be valid for the OpenSearch k-NN model and the application may need query changes after migration.
