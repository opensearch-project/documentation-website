...
The flags that follows.cover the cases most community users hit. The script always installs the matching Helm chart and CloudWatch dashboards after the CloudFormation stack succeeds.
...
This step shows how to deploy Migration Assistant into either a new VPC or an existing VPC.
