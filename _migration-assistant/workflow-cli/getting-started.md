...
For a complete reference of all available fields, their types, defaults, and descriptions, see the [Migration Assistant Schema Viewer](https://opensearch-project.github.io/opensearch-migrations/). For complete configuration examples, see the [Playbooks]({{site.url}}{{site.baseurl}}/migration-assistant/playbooks/).
