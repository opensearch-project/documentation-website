...
- Migration Assistant does not guarantee zero-downtime migration via live traffic capture and replay for migration paths starting from elasticsearch 1.x and elasticsearch 2.x.