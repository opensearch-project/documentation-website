...
| **Index State Management (ISM) policies**  | Expected in 2025    | Manually migrate using an API. For more information on ISM support, see [issue #944](https://github.com/opensearch-project/opensearch-migrations/issues/944). |
...
[^2]: Kibana 5.0 - 7.10.2 will be supported with Elasticsearch Kibana to OpenSearch Dashboards Support on all supported source paths. Kibana 8+ is unsupported.
