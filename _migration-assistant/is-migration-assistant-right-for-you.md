...
- Migration Assistant does not guarantee zero-downtime migration through live traffic Capture and Replay for migration paths for Elasticsearch 1.x and Elasticsearch 2.x.
