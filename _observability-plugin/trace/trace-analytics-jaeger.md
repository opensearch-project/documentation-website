...
If you select an individual trace ID, you can see more detailed information about the trace, such as **Time spent by the service** and **Spans** for the service per operation. You can also view the payload received from the index in JSON format.
