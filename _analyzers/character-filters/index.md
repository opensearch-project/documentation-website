...
- **ICU normalization**: The [`icu_normalizer`]({{site.url}}{{site.baseurl}}/analyzers/character-filters/icu-normalization/) character filter converts text into a canonical Unicode form before tokenization, ensuring that equivalent characters are treated consistently. Requires the `analysis-icu` plugin.
- **Japanese iteration marks**: The [`kuromoji_iteration_mark`]({{site.url}}{{site.baseurl}}/analyzers/character-filters/kuromoji-iteration-mark/) character filter expands Japanese iteration marks to the character they represent, normalizing the text before tokenization. Requires the `analysis-kuromoji` plugin.
