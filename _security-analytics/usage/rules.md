...
Alternatively, you can use the **Rule type**, **Rule severity**, and **Status** dropdown menus to drill down in the list of alerts and filter for preferred results. You can use all three menus in combination to narrow results. Select only one option per menu.
...
1. After you confirm the information for the rule is accurate, select the **Create** button in the lower-right corner of the window. A new rule is created, and it appears in the 

## Creating a rule by duplication

An alternative to importing a rule is duplicating a Sigma rule and then modifying it to make it a custom rule.
