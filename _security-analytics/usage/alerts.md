...
- Two tabs:
  - **Findings**: Lists detector-generated alerts, showing details such as alert time, trigger name, and detector that triggered the alert.
...
The **Alerts** graph displays alerts by their status or severity. Use the **Group by** dropdown list to specify either **Alert status** or **Alert severity**.
