...
1. If desired, create custom rules by duplicating and then modifying pre-packaged rules. See [Custoomizing rules]({{site.url}}{{site.baseurl}}/security-analytics/usage/rules#customizing-rules) for details.
