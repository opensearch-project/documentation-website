...
- [Standard log types](#standard-log-types): A list of data sources that Security Analytics automatically populates field mappings and rules for, depending on the data indexed from the source.
