...
Security Analytics uses prepackaged Sigma rules for detector creation. It can automatically map important fields of a particular log type with the relevant fields in Sigma rules. In the **Field Mappings** section for detector creation is a view of fields that have been mapped automatically. From this view, you can customize, change, or add new field mappings. When a detector includes customized rules, you can manually map detector rule field names to log source field names.
