...
|:--------------------------------------|:-----------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
 ...
 | `source.ioc_upload`                   | Object           | Details for IOC upload. Applicable for `IOC_UPLOAD` type                                                                                                           |
 | `source.ioc_upload.file_name`         | String           | The name of the file containing IOCs. Example: `test`.Applicable for `IOC_UPLOAD` type                                                                             |
