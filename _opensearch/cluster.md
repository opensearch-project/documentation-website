...
Dynamic | Delegates a specific node for custom work, such as Machine Learning (ML) tasks, preventing the consumption of resources from data nodes, therefore not affecting any OpenSearch functionality. 
