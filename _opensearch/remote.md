...
If the security plugin is enabled, a user must have the `cluster:admin/remotestore/restore` permission. See [Access control]({{site.url}}{{site.baseurl}}/security/access-control/index/) for information about configuring user permissions.
{: .note}