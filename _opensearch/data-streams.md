...
You can also use [asynchronous search]({{site.url}}{{site.baseurl}}/search-query/async/index/), [SQL]({{site.url}}{{site.baseurl}}/search-query/sql/index/), and [PPL]({{site.url}}{{site.baseurl}}/search-query/sql/ppl/index/) to query your data stream directly. You can also use the security plugin to define granular permissions for the data stream name.
