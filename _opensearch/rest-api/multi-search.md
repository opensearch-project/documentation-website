...
cancel_after_time_interval | Time | The time after which the search request will be cancelled. Supported at both parent and child request levels. The order of precedence is:<br> 1. Child-level parameter<br> 2. Parent-level parameter<br> 3. [Cluster setting](../cluster-settings).<br>Default is -1. | Yes
