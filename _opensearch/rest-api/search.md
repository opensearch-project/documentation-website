...
cancel_after_time_interval | Time | The time after which the search request will be cancelled. Request-level parameter takes precedence over cancel_after_time_interval [cluster setting](../cluster-settings). Default is -1.
