...
`copy_alias` | This parameter controls whether to copy over all the aliases from current index to newly created index, defaults to false. | `boolean` | `true` or `false` | No
