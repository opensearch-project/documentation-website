...
If you want to append data from an existing index to the new append-only index, use the Reindex API. The following example reindexes documents from a source index (`logs`) into the new append-only index:
