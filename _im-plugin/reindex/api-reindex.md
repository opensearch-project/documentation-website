...
You can copy all documents from one index to another using the [Reindex Documents API]({{site.url}}{{site.baseurl}}/api-reference/document-apis/reindex/).

The following procedures demonstrate how to reindex documents under various conditions using this API.
...
For index codec considerations, see [Index codecs]({{site.url}}{{site.baseurl}}/im-plugin/index-other/index-codecs/#reindexing).
