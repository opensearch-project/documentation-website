...
To learn about full-text queries in OpenSearch, see [Full-text queries]({{site.url}}{{site.baseurl}}/search-query/query-dsl/full-text/).
...
Please, refer to `match` query [documentation]({{site.url}}{{site.baseurl}}/search-query/query-dsl/full-text/#match) for parameter description and supported values.
...
Please, refer to `query_string` query [documentation]({{site.url}}{{site.baseurl}}/search-query/query-dsl/full-text/#query-string) for parameter description and supported values.
...
Please, refer to `match_phrase` query [documentation]({{site.url}}{{site.baseurl}}/search-query/query-dsl/full-text/#match-phrase) for parameter description and supported values.
...
Please, refer to `simple_query_string` query [documentation]({{site.url}}{{site.baseurl}}/search-query/query-dsl/full-text/#simple-query-string) to check parameter meanings and available values.
...
Please, refer to `match_phrase_prefix` query [documentation]({{site.url}}{{site.baseurl}}/search-query/query-dsl/full-text/#match-phrase-prefix) for parameter description and supported values.
...
Please, refer to `match_bool_prefix` query [documentation]({{site.url}}{{site.baseurl}}/search-query/query-dsl/full-text/#match-boolean-prefix)  for parameter description and supported values.
