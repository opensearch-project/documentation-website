...
Use `sort` with the [`search_after` parameter]({{site.url}}{{site.baseurl}}/search-query/customizing-search/paginate#the-search_after-parameter) for more efficient scrolling.
