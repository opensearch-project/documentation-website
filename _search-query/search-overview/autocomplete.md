...
To learn about the `max_expansions` option, see [Other optional query fields]({{site.url}}{{site.baseurl}}/search-query/query-dsl/full-text#other-optional-query-fields).
