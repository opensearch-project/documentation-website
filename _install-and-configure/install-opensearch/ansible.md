...
The Ansible playbook only supports deployment of OpenSearch and OpenSearch Dashboards to the most popular Linux distributions (Centos7, RHEL7, Amazon Linux 2, Ubuntu 20.04) hosts.
{: .note }
