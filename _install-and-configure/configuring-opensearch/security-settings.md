...
- `plugins.security.compliance.immutable_indices` (Static): Documents in indices marked as immutable follow the write-once, read-many paradigm. Therefore documents created in these indexes cannot be changed.
