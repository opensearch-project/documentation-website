...
If you only need `docvalue_fields`, `size`, and `sort`, then [`top_metrics`]({{site.url}}{{site.baseurl}}/aggregations/metric/top-metrics/) might be a more efficient choice.
{: .tip}
...
- [Explain]({{site.url}}{{site.baseurl}}/api-reference/search/#the-explain-parameter)
- [Source filtering]({{site.url}}{{site.baseurl}}/api-reference/search/#the-_source-parameter)
- [Stored fields]({{site.url}}{{site.baseurl}}/search-plugins/searching-data/retrieve-specific-fields/#searching-with-stored_fields)
- [Script fields]({{site.url}}{{site.baseurl}}/search-plugins/searching-data/sort/#sorting-by-script)
...
- [Include versions]({{site.url}}{{site.baseurl}}/api-reference/document-apis/index-document/#path-and-http-methods)
