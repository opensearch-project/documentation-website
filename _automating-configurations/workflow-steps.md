...
| `agent_id`	     |String	| The `agent_id` is used as an input for several steps.                                                                                                                                                                                                                                                                                                                               |
| `connector_id`	 |String	| The `connector_id` is used as an input for several steps.                                                                                                                                                                                                                                                                          |

For `create_tool` step type, `model_id`, `agent_id` and `connector_id` will be passed as the essential parameter into the `MLModelTool`, `AgentTool` and `ConnectorTool` respectively.
{: .note}
