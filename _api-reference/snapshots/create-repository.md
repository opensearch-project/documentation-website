...
| `region`                                    | Region of where the S3 bucket is located. Optional.  If missing, values `s3.client.default.region` are used from `opensearch.yml`                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `endpoint`                                    | Endpoint of the S3 bucket. Optional.  Required if `region` is set since Opensearch `2.9`.  For example, for `us-west-2`, use `https://s3.us-west-2.amazonaws.com`.  If missing, values `s3.client.default.endpoint` are used from `opensearch.yml`                                                                                                                                                                                                                                                                                                                                                                                                                                     |
