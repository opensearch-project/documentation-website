...
| `pointer_based_lag_update_interval` | The interval at which pointer-based lag must be calculated. Supports time units. Default value is 10s. Setting this to 0 disables pointer-based lag calculation entirely. |
