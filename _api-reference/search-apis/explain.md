...
If you want to know why a specific document ranks higher (or lower) for a query, you can use the Explain API to produce an explanation of how the relevance score (`_score`) is calculated for every result.
