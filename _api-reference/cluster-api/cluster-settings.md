...
| `cluster_minimum_index_refresh_interval` | Time unit | Sets the minimum index refresh interval. Default is `10s`.
`cluster_default_index_refresh_interval` | Time unit | Sets the default index refresh interval in seconds.
