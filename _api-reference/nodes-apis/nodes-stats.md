...
search.startree_query_total | Integer | The total number of query operations that use star-tree for search.	
search.startree_query_time_in_millis | Integer | The total amount of time taken by all query operations that use star-tree for search, in milliseconds.	
search.startree_query_current | Integer | The number of currently running query operations that use star-tree for search.	
