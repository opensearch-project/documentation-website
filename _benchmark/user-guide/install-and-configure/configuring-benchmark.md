...
| `basic_auth_user` | String | User for authentication to your OpenSearch if enabled. |
| `basic_auth_password` | String | User for authentication to your OpenSearch if enabled. |
