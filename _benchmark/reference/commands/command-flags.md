...
Downloads the specified OpenSearch distribution based on version number. For a list of released OpenSearch versions, see [Version history]({{site.latesturl}}{{site.baseurl}}/version-history/).
