...
nav_order: 10
canonical_url: https://opensearch.org/docs/latest/troubleshoot/security-admin/
---
...
You must use an admin certificate when executing the script. To learn more, see [Configuring admin certificates]({{site.url}}{{site.baseurl}}/security/configuration/tls/#configure-admin-certificates).
