...
[`disable_objects`]({{site.url}}{{site.baseurl}}/mappings/mapping-parameters/support-for-field-name-with-dots/) | Controls whether dotted field names are expanded into nested object structures or treated as literal flat field identifiers, ensuring deterministic ingestion for metrics and analytics workloads.
