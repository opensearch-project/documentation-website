...
Interaction with the ML Commons plugin occurs through either the [REST API]({{site.url}}{{site.baseurl}}/ml-commons-plugin/api) or [`ad`]({{site.url}}{{site.baseurl}}/search-query/sql/ppl/functions#ad) and [`kmeans`]({{site.url}}{{site.baseurl}}/search-query/sql/ppl/functions#kmeans) Piped Processing Language (PPL) commands.
