...
The following table lists all tools OpenSearch supports.

|Tool	| Description	|
|:---	|:---	|:---	|:---	|
|`PPLTool`	|Translates natural language into a PPL query and has an option to run the query and return the query and results.	|
|---	|---	|---	|---	|
...
|`SearchAlertsTool`	|Searches for alerts.	|Yes	|
...
|`IndexMappingTool`	|Retrieves index mapping information for an index. |
