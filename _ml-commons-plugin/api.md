...
The profile API returns additional information when the [auto redeploy]({{site.url}}{{site.baseurl}}/ml-commons-plugin/api#enable-auto-redeploy) cluster setting is set to `true`.
