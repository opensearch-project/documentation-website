...
nav_order: 120
canonical_url: https://docs.opensearch.org/docs/latest/ml-commons-plugin/pretrained-models/
---
...
- Use the `amazon/neural-sparse/opensearch-neural-sparse-encoding-doc-v3-distill` model during ingestion and the
