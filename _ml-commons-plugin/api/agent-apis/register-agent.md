...
`parameters.output_processors` | Array | Optional | A list of processors to transform the tool's output. For more information, see [Processor Chain]({{site.url}}{{site.baseurl}}/ml-commons-plugin/processor-chain/).
