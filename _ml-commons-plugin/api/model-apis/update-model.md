...
You can update a model's interface to define input and output schemas. This is useful for models that lack a default interface or require customization. For more information, see [Model Interface]({{site.url}}{{site.baseurl}}/ml-commons-plugin/api/model-apis/register-model/#the-interface-parameter). 
