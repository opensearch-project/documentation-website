...
Note that Bedrock access keys expire in 10--12 hours after creation. To learn more, about the parameters in the preceding request, see [Creating connectors for third-party ML platforms]({{site.url}}{{site.baseurl}}/ml-commons-plugin/extensibility/connectors/).
