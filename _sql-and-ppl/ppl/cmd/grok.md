...
The grok command has the same limitations as the parse command, see [parse limitations]({{site.url}}{{site.baseurl}}/sql-and-ppl/ppl/cmd/parse#limitations) for details.