...
`trendline [sort <[+|-] sort-field>] [sma|wma]({{site.url}}{{site.baseurl}}/sql-and-ppl/ppl/cmd/number-of-datapoints-field/) [as <alias>] [[sma|wma]({{site.url}}{{site.baseurl}}/sql-and-ppl/ppl/cmd/number-of-datapoints-field/) [as <alias>]]...`
