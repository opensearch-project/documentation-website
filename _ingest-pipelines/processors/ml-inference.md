...
| `ignore_missing` | Boolean   | Optional | If `true` and any of the input fields defined in `input_map` or `output_map` are missing, the missing fields are quietly ignored. Otherwise, a missing field causes a failure. Default is `false`.                                                                                                                                                                                                                      |
