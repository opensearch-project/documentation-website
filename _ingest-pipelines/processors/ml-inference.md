...
| `ignore_failure` | Boolean | Optional | If true and any exceptions occur, they are quietly ignored, and the ingestion continues. Otherwise, an exception can occur and abort the ingestion. Default is false.                                                                                                                                                                                                                                             |
...
The mappings for input_map and output_map also support standard json path notation to complex data structures.
...
Currently, ml inference processor only supports remote models connected through a connector. Local models uploaded to OpenSearch cluster are not supported. Please watch the future versions for new releases.
