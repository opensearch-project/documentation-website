...
|---|---|---|
`source_field`  | Required  | The name of the field which will be copied. Supports [template snippets]({{site.url}}{{site.baseurl}}/ingest-pipelines/create-ingest/#template-snippets). |
