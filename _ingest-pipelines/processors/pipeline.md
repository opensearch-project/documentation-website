...
The `pipeline` processor is used to <explain what is used to do>.
...
The following query creates a pipeline, named <name>, that uses the `pipeline` processor to <do what?>: 
