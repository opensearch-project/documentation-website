...
The `max_chunk_limit` parameter limits the number of chunked passages. If the number of passages generated by the processor exceeds the limit, the algorithm will add the excess part to the existing last chunk. For example, if you set token_limit to 
{: .note}
...
The `max_chunk_limit` parameter limits the number of chunked passages. If the number of passages generated by the processor exceeds the limit, the algorithm will add the excess part to the existing last chunk.
{: .note}
