...
The `max_chunk_limit` parameter limits the number of chunked passages. If the number of passages generated by the processor exceeds the limit, the algorithm will put the exceeding part into the last chunk.
{: .note}
