...
`allow_duplicates` | Optional | Specifies whether to append the values that the field already contains. If `true`, duplicate values are appended, otherwise they are skipped. |
