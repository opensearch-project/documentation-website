...
`properties` | Optional | A list of properties to be extracted from the user agent string and added to the `target_field`. If not specified, the default properties are ["name", "major", "minor", "patch", "build", "os", "os_name", "os_major", "os_minor", "device"].
