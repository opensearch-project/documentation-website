...
For information about querying data in OpenSearch Dashboards, including the Dashboards Query Language (DQL), see [Analyzing data with Discover]({{site.url}}{{site.baseurl}}/discover/index-discover/).
