...
[`ml_inference`]({{site.url}}{{site.baseurl}}/search-plugins/search-pipelines/ml-inference-processor/) | Invokes registered machine learning (ML) models in order to rewrite queries. | 2.16 
...
[`ml_inference`]({{site.url}}{{site.baseurl}}/search-plugins/search-pipelines/ml-inference-processor/) | Invokes registered machine learning (ML) models in order to incorporate model output as additional search response fields. | 2.16 
