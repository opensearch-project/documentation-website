...
The `knn_vector` data type supports a vector of floats that can have a dimension of up to 16000 for the nmslib and faiss engines, as set by the dimension mapping parameter. The maximum dimension for the Lucene library is 1024.
