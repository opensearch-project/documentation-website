...
The following sections cover the specific functionality that the Learning to Rank plugin provides. This information helps you build and upload features for your learning to rank (LTR) system. See [Core concepts]({{site.url}}{{site.baseurl}}/search-plugins/ltr/core-concepts/) and [Fits in]({{site.url}}{{site.baseurl}}/search-plugins/ltr/fits-in/) for more information about the Learning to Rank plugin's roles and functionality. 
