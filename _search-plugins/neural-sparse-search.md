...
**PREREQUISITE**<br>
Before using sparse search, you could set up a pretrained sparse embedding model or use your own. For more information, see [Using custom models within OpenSearch]({{site.url}}{{site.baseurl}}/ml-commons-plugin/ml-framework/).
{: .note}
