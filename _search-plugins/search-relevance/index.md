...
One use case for Compare Search Results is to compare raw OpenSearch results with the same results processed by a reranking application. The following two rerankers currently integrate with OpenSearch:
