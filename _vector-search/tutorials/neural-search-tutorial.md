...
- [**Manual tutorial steps workflow**]((#step-1-choose-a-model)) By skipping to step 1 of the manual tutorial where each api is executed separetly:
...
## Automating setup for semantic and sybrid Search
