...
To simplify setup, the Flow Framework plugin allows you to automatically create an ingest pipeline and an indexwith a single API call. This reduces manual configuration while ensuring best practices for multimodal search.
...
If you need a fully customized setup, follow the manual steps below.
