...
If the [Remote Index Build](https://docs.opensearch.org/docs/latest/vector-search/remote-index-build/) feature flag is enabled, the following statistics will be included:
