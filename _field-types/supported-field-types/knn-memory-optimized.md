...
{: .note}
Starting with version 3.1, enabling ‘on_disk’ mode with a ‘1x’ compression level activates memory-optimized search, where the engine loads bytes on demand during search instead of loading everything into memory upfront.
{: .warning}
