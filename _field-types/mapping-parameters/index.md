...
`boost` | Specifies a field-level query time to boost. Default boost value is `1.0`, which means that no boost is applied. Allowed values are any floating-point number.
