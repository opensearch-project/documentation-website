...
1. **PPL**: Runs a PPL (Piped Processing Language) query and generates alerts based on the number of results or a custom condition. See [PPL monitors]({{site.url}}{{site.baseurl}}/observing-your-data/alerting/ppl-monitors/) for information about creating and using this monitor type.
