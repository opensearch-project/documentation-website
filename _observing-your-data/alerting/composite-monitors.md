...
| Term | Definition |
| :--- | :--- |
| Composite monitor | composite monitor is a type of monitor that supports executing multiple query/doc/bucket level monitors in sequential fashion. it supports configuring triggers to create chained alerts. |
| Delegate monitor | Delegate monitors are executed sequentially according to their order in the monitor definition. |
...
#### Using Painless scripting language to define chained alert triggers
