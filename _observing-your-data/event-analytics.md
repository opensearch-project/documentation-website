...
Presenting your visualizations on a dashboard, instead of the event analytics page, makes it easier for users to understand and interpret the data at a glance. To create a new visualization and add it to a dashboard, follow these steps:
...
The following image shows you an example observability dashboard.

![Example dashboard displaying event analytics visualizations]({{site.url}}{{site.baseurl}}//images/dashboards/event-analytics-dashboard.png)
