...
1. Specify the data source.   
   - For **Data source**, choose the index or indexes you want to use as the data source. You can also optionally use an alias or an index patterns to choose multiple indexes. 
