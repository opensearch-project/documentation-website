...
When selecting the [**Enable flattened custom result index**]({{site.url}}{{site.baseurl}}/observing-your-data/ad/index/#flattening-nested-fields/) in the **Custom result index** pane, the Anomaly Detection plugin saves the results with all of the nested fields flattened in the index.
