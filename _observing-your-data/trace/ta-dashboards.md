...
- `observability:traceAnalyticsServiceMapMaxEdges`: The maximum number of edges (service-to-service connections) displayed. Default is 1000.

To configure these settings in OpenSearch Dashboards, follow these steps:
1. On the main menu, select **Management** > **Dashboard Management** > **Advanced Settings**.
