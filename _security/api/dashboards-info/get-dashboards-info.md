---
layout: default
title: Get Dashboards Info API
parent: Dashboards Info APIs
grand_parent: Security APIs
nav_order: 10
---

# Get Dashboards Info API
**Introduced 1.0**
{: .label .label-purple }
...
<!-- spec_insert_start
api: security.get_dashboards_info
component: endpoints
-->
## Endpoints
```json
...
rest: GET /_plugins/_security/dashboardsinfo
-->
{% capture step1_rest %}
GET /_plugins/_security/dashboardsinfo
{% endcapture %}
...
response = client.security.get_dashboards_info()
{% endcapture %}
