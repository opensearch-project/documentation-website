...
Before generating a signed certificate, create a SAN extension file which describes the DNS A record for the host. If you're connecting to a host that only has an IP address, both IPv4 and IPv6, use the `IP` syntax:
