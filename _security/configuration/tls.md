...
For more information about admin and super admin user roles, see [Admin and super admin roles](https://docs.opensearch.org/latest/security/access-control/users-roles/#admin-and-super-admin-roles). 
