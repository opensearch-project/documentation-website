...
In technical documentation and the UI, use *indexes* as the plural form of *index*. Use *indices* only in the context of mathematical expressions. Non-hardcoded references to *indices* should be changed to *indexes*.
